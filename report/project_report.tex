...
We created a dataset of classical Azerbaijani poetry to understand structural and linguistic properties. The dataset contains poems from major poets including Muhəmmad Fuzuli, Imadaddin Nasimi, Qasim bey Zakir, Xaqani Shirvani, Molla Panah Vagif, and others.
...
We used a Go-based system with Wikimedia API to collect 846 poems (909,630 characters original, 19,495 modernized). We cleaned metadata artifacts and generated modern translations using Gemini 2.5 Flash while preserving poetic structure.
...
\begin{itemize}
    ...
    \item Error types tested: anglicization, phonetic variations, OCR errors
    \item Overall accuracy: 12.83\%
\end{itemize}
...
Our work has several limitations including incomplete modern text coverage and challenges in bridging classical-contemporary vocabulary gaps. The spell checker's 12.83\% accuracy, while low, establishes a baseline for historical text correction systems.
